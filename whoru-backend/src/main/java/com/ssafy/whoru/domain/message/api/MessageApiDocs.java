...
public interface MessageApiDocs {
    ...
    ResponseEntity<WrapResponse<Void>> sendTextResponseMessage(@RequestBody TextSend textSend);
    ...
    ResponseEntity<WrapResponse<List<MessageResponse>>> findRecentMessages(@RequestParam(name = "firstid") Long firstId);
    ...
    ResponseEntity<WrapResponse<SliceMessageResponse>> findOldMessages(@RequestParam(name = "lastid", required = false) Long lastId, @RequestParam Integer size);
}

...
public class AdminApiTest extends TestPrepare {
    ...
    void 공지사항_작성_성공_201() throws Exception{
        ...
        PostNotificationRequest request = boardTestUtil.공지사항_생성(BoardTestUtil.정상_문자열, BoardTestUtil.정상_문자열);
    ...
    void 공지사항_제목_글자수_최소제한_400() throws Exception{
        ...
        PostNotificationRequest request = boardTestUtil.공지사항_생성(BoardTestUtil.정상_문자열, BoardTestUtil.짧은_문자열);
    ...
    void 공지사항_제목_글자수_최대제한_400() throws Exception{
        ...
        PostNotificationRequest request = boardTestUtil.공지사항_생성(BoardTestUtil.정상_문자열, BoardTestUtil.긴_문자열);
    ...
    void 공지사항_내용_글자수_최소제한_400() throws Exception{
        ...
        PostNotificationRequest request = boardTestUtil.공지사항_생성(BoardTestUtil.짧은_문자열, BoardTestUtil.정상_문자열);
    ...
    void 공지사항_내용_글자_최대제한_400() throws Exception{
        ...
        PostNotificationRequest request = boardTestUtil.공지사항_생성(BoardTestUtil.긴_문자열, BoardTestUtil.정상_문자열);
